    ...
    const templates = [
      {
        ...
        menu_permissions: {
          ...
          '/klhk-reporting': { access: true, read: true, create: true, update: true, delete: true },
          ...
          '/site-health': { access: true, read: true, create: true, update: true, delete: true },
      ...
      },
      {
        ...
        menu_permissions: {
          ...
          '/klhk-reporting': { access: true, read: true, create: false, update: true, delete: false },
          ...
          '/site-health': { access: true, read: true, create: false, update: false, delete: false },
      ...
      },
      {
        ...
        menu_permissions: {
          ...
          '/klhk-reporting': { access: false, read: false, create: false, update: false, delete: false },
          '/data': { access: true, read: true, create: false, update: false, delete: false },
          '/data-dash': { access: true, read: true, create: false, update: false, delete: false },
          '/data-dash-2': { access: true, read: true, create: false, update: false, delete: false },
          '/comparison-dashboard': { access: true, read: true, create: false, update: false, delete: false },
      ...
      },
      {
        ...
        menu_permissions: {
          ...
          '/klhk-reporting': { access: true, read: true, create: false, update: false, delete: false },
  ...
  try {
    const availableMenus = [
      ...
      },
      {
        path: '/status',
        name: 'Status',
        description: 'Status-category parameters (battery, health, etc.)',
        category: 'Data'
      },
      {
        path: '/quick-view',
      ...
      },
      {
        path: '/live-tracking',
        name: 'Live tracking',
        description: 'Map live GPS and history with sensor snapshots',
        category: 'Device'
      },
      {
        path: '/listeners',
      ...
      },
      {
        ...
        description: 'Doughnut comparison metrics (realtime or day vs day)',
        category: 'Data'
      },
      {
        path: '/site-health',
        name: 'Site Health',
        description: 'Compare devices in a group on one parameter (week or month)',
        category: 'Data'
      },
      {
        path: '/alerts',
      ...
      },
      {
        ...
        description: 'Configure MQTT subscribe topics and payload expectations per device',
        category: 'Device'
      },
      {
        path: '/mqtt-publisher',
      ...
      },
      {
        path: '/klhk-reporting',
        name: 'KLHK Reporting',
        description: 'Backup SPARING/TMAT reporting to KLHK from cloud data',
        category: 'Device'
      },
      {
        path: '/company-site',
