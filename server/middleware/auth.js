    ...
    try {
      ...
      if (!hasAccess) {
        const fallbackPermissions = {
          'operator': ['/dashboard', '/u-dashboard', '/devices', '/live-tracking', '/data', '/data-dash', '/comparison-dashboard', '/alerts', '/alert-settings', '/scheduled-exports', '/maintenance', '/company-site', '/sensor-management'],
          'operate': ['/dashboard', '/u-dashboard', '/devices', '/live-tracking', '/data', '/data-dash', '/comparison-dashboard', '/alerts', '/alert-settings', '/scheduled-exports', '/maintenance', '/company-site', '/sensor-management'],
          'viewer': ['/dashboard', '/u-dashboard', '/devices', '/live-tracking', '/data', '/data-dash', '/comparison-dashboard', '/alerts', '/alert-settings', '/scheduled-exports', '/maintenance', '/company-site', '/sensor-management'],
