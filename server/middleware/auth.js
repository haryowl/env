    ...
    try {
      ...
      if (!hasAccess) {
        const fallbackPermissions = {
          ...
          'viewer': ['/dashboard', '/u-dashboard', '/status', '/devices', '/live-tracking', '/data', '/data-dash', '/comparison-dashboard', '/alerts', '/alert-settings', '/scheduled-exports', '/maintenance', '/company-site', '/sensor-management'],
